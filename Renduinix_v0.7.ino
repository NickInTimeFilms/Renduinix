/*
  ...
  v0.7 Added EEPROM presets and reset, revamped vehicle selection
*/
...
byte RGBOrder = 0; //0 = Red, Orange, Yellow, Green, Cyan, Blue, Purple, Pink, White, 9 = Custom
byte RGBTotal = 10;
